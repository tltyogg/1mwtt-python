...
from seo_keywords.items import SeoKeywordsItem
import scrapy


class SeoSpider(scrapy.Spider):
    name = 'seo_spider'
    allowed_domains = ['womenwhocode.com']
    start_urls = ['https://www.womenwhocode.com/']


    def parse(self, response):
        item = SeoKeywordsItem()
...
# scrapy crawl seo_spider -o seo_spider.csv -t csv
